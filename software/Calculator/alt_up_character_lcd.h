...
**/
int alt_up_character_lcd_write(alt_up_character_lcd_de v *lcd, const char *ptr, unsigned int len);
...
* @return 0 for success
**/
int alt_up_character_lcd_set_cursor_pos(alt_up_charact er_lcd_dev *lcd, unsigned x_pos, unsigned y_pos);
...
* @return 0 for success
**/
int alt_up_character_lcd_shift_cursor(alt_up_character _lcd_dev *lcd, int x_right_shift_offset);
...
* @return 0 for success
**/
int alt_up_character_lcd_shift_display(alt_up_characte r_lcd_dev *lcd, int x_right_shift_offset);
...
* @return 0 for success
**/
int alt_up_character_lcd_erase_pos(alt_up_character_lc d_dev *lcd, unsigned x_pos, unsigned y_pos);
